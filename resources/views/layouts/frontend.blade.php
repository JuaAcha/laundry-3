...
<body>
    ...
    <div class="footer-copyright">
        <div class="container">
            &copy; <?php echo date("Y") ?> Build With <i class="fa fa-heart" style="color:red"></i> - <a href="https://instagram.com/hamskie.__?igshid=YmMyMTA2M2Y=" target="_blank" style="text-decoration:none">HamsSkie</a>
        </div>
    </div>
